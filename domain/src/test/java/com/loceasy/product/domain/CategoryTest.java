...
import com.loceasy.product.domain.category.Category;
import com.loceasy.product.domain.exceptions.DomainException;
import com.loceasy.product.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAValidParams_whenCallNewCategory_thenInstantiateACategory() {
        final var expectedName = "Produtos";
        final var expectedDescription = "Brinquedos";
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final var expectedName = """
                No mundo atual, a determinação clara de objetivos nos obriga à análise das diversas correntes de pensamento. 
                Desta maneira, o julgamento imparcial das eventualidades auxilia a preparação e a composição do retorno esperado a longo prazo
    ...
    @Test
    public void givenAValidInactiveCategory_whenCallDeactivate_thenReturnCategoryActived() {
        final var expectedName = "Produtos";
        final var expectedDescription = "Brinquedos";
        final var expectedIsActive = true;
    ...
    public void givenAValidCategory_whenCallUpdate_thenReturnCategoryUpdated() {
        ...
        final var aCategory =
                Category.newCategory("locação", "A categoria", false);
